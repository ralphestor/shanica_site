    ...
    <div className='homeContainer'>
      ...
      <main>
        ...
        <div className='homeSocialIcons'>
              <Link href='https://www.youtube.com/user/shanica1' target="_blank" rel="noreferrer" passHref>
                <a className='socialIconsCont'>
                  <Icon  className="socialIcons" icon="akar-icons:youtube-fill" color="rgba(0, 0, 0, 0.2)" height="30" />
                </a>
              </Link>

              <Link href='https://www.instagram.com/its.shanica/' target="_blank" rel="noreferrer" passHref>
                <a className='socialIconsCont'>
